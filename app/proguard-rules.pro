...
-keep class com.blockchain.vex.network.models.** { *; }
-keepclassmembers enum com.blockchain.vex.network.models.** { *; }

-keep class com.blockchain.vex.data.database.entities.** { *; }
-keepclassmembers enum com.blockchain.vex.data.database.entities.** { *; }
